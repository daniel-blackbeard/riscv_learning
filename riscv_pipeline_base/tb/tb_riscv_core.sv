...
initial begin
  ...
  check("mem[0] (sw x5)", {u_riscv32_dut.u_data_mem.ram3[0], u_riscv32_dut.u_data_mem.ram2[0],
                            u_riscv32_dut.u_data_mem.ram1[0], u_riscv32_dut.u_data_mem.ram0[0]}, 32'd50);
  check("mem[4] (sw x7)", {u_riscv32_dut.u_data_mem.ram3[1], u_riscv32_dut.u_data_mem.ram2[1],
                            u_riscv32_dut.u_data_mem.ram1[1], u_riscv32_dut.u_data_mem.ram0[1]}, 32'd51);

  // ---- done marker: proves the program ran to completion (reached the halt
  //      loop) without depending on any absolute code address ----
  check("mem[1020] (done)", {u_riscv32_dut.u_data_mem.ram3[255], u_riscv32_dut.u_data_mem.ram2[255],
                              u_riscv32_dut.u_data_mem.ram1[255], u_riscv32_dut.u_data_mem.ram0[255]}, 32'd111);
